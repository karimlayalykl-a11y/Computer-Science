...
subkeyss= subkeys(key_in_binary)
...
if mode == "E": 
    cipher_binary = encrypt(binary_text)
    cipher_hexa = hex(int(cipher_binary, 2))[2:].upper().zfill(16) 

    print("\n ENCRYPTION ")
    print("Cipher (Hexadecimal):", cipher_hexa)
    print("Cipher (binary):", cipher_binary)
    ...
    #telling the user to enter the ciphertext 
    ...
    print("\n DECRYPTION ")
    print("Plaintext (Hexadecimal):", plain_hexa)
    print("Plaintext (Binary):", plain_binary)
    print("ASCII Final Output :", plain_text)
